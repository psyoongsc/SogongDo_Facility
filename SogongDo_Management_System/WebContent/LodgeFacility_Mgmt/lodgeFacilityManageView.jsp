...
<h3>숙박 시설 관리</h3>
	...
	<form align="center" action="#", method="GET">
		<input class="bt" type="button" value= "숙박시설 등록하기" id="btnEnroll" onclick="fEnroll()">
		<input class="bt" type="button" value= "숙박시설 수정하기" id="btnUpdate" onclick="fUpdate()">
		<input class="bt" type="button" value= "숙박시설 삭제하기" id="btnDelete" onclick="fDelete()">
	</form>
</body>
