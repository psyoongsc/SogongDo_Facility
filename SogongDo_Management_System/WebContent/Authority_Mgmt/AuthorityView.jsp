...
<div class="AuthorityInfo">
    <div class = "tableview">
        ...
        <button class="bt" onclick="enrollPopUp()">권한정보 등록하기</button>
        <button class="bt" onclick="deletePopUp()">권한정보 삭제하기</button>
        <button class="bt" onclick="updatePopUp()">권한정보 수정하기</button>
