...
<h3>시설 요금 할인 관리</h3>
	...
	function mySubmit(index) {
		...
		if(count > 0){
			if(index==1){
				document.selectItem.action="/SogongDo_Management_System/Facility/Charge/discount/update";
			}
			if(index==2){
				if (confirm("정말 삭제하시겠습니까?") == true){
					document.selectItem.action="/SogongDo_Management_System/Facility/Charge/discount/delete";
				}else{
					return false;
				}
			}
