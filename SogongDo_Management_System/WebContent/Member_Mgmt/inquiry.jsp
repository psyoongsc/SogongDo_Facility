...
<%@ page import="Member_Mgmt.persistance.*" %>
...
<%@ include file="../head_banner.jsp" %>
                ...
                <tbody>
					...
					%>
					 <tr>
                       	...
                       	<td><%= dto.getMember_Password().replaceAll(".", "*") %></td>
	...
	window.addEventListener("load",function(){
		...
		registerbtn.addEventListener("click",()=>{
			//새로운 창 뜨도록 하기
			window.open("/SogongDo_Management_System/Member_Mgmt/register.jsp","새로운 회원 등록","width=500, height=400, left=300, top=300");
		})
		...
		deletebtn.addEventListener("click",()=>{
			...
			if(ids.length==0){
				...
				if(ox){
					var url = "/SogongDo_Management_System/Member/delete?";
					url += "cnt="+ids.length+"&";
		...
		updatebtn.addEventListener("click",()=>{
			...
			if(cnt==0){
				...
				window.open("/SogongDo_Management_System/Member/update/view?id="+up,"회원 정보 수정","width=500, height=400, left=300, top=300");
			}else{
				alert('하나만 체크해주세요');
			}
		})
